...
const KolibriIcons = {
  ...
  female: { icon: require('./precompiled-icons/material-icons/female/baseline.vue').default },
  male: { icon: require('./precompiled-icons/material-icons/male/baseline.vue').default },
