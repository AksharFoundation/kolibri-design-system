export const defaultTokenMapping = {
  // brand shortcuts
  primary: 'palette.lightgreen.v_500',
  primaryDark: 'palette.lightgreen.v_800',
  ...
  link: 'palette.lightgreen.v_500',
  linkDark: 'palette.lightgreen.v_800',
  loading: 'brand.secondary.v_200',
  focusOutline: 'brand.secondary.v_200',
  surface: 'palette.white',
  fineLine: '#dedede',
  appBar: 'palette.lightgreen.v_500',
  appBarDark: 'palette.lightgreen.v_800',
